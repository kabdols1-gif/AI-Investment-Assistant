...
function ToastItem({ toast, onRemove }: ToastItemProps) {
  ...
  return (
    <div
      className={cn(
        "flex max-w-full items-center gap-3 rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-lg transition-all duration-200 dark:border-slate-700 dark:bg-slate-800",
