...
export const BROKER_PROVIDER_OPTIONS: BrokerProviderOption[] = [
  {
    ...
    description: "KB증권 BaaS API",
    defaultBaseUrl: "https://ddeveloper.kbsec.com:32484",
    baseUrlPlaceholder: "https://ddeveloper.kbsec.com:32484",
  ...
  },
  {
    ...
    defaultBaseUrl: "",
    baseUrlPlaceholder: "증권사 Base URL",
    connectionTestSupported: false,
  },
  {
    id: "nh",
  ...
  },
  {
    ...
    name: "직접 입력",
    mark: "API",
    description: "다른 국내 증권사 API",
    defaultBaseUrl: "",
    baseUrlPlaceholder: "증권사 Base URL 직접 입력",
    connectionTestSupported: false,
  },
];
