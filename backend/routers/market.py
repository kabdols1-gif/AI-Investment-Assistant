...
from backend.services.kb_market_service import KBMarketServiceError, get_kb_current_price
...
async def get_current_price(
    ...
    except KBMarketServiceError as e:
        logging.error(f"KB 현재가 조회 에러: {e}")
        return {
            "status": "error",
            "message": str(e)
        }
